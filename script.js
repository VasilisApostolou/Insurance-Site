...
const translations = {
    ...
    el: {
        ...
        home_intro: "Η ζωή είναι απρόβλεπτη, αλλά η προστασία σας δεν χρειάζεται να είναι. Ως εταιρεία μεσιτείας ασφαλίσεων, το πάθος μας είναι να σας βοηθάμε να πλοηγηθείτε στον κόσμο του ρίσκου και να βρείτε την ιδανική κάλυψη για ό,τι έχει μεγαλύτερη σημασία. Είτε είστε επαγγελματίας οδηγός που μεταφέρει πολύτιμο φορτίο, μια οικογένεια που αναζητά να εξασφαλίσει το μέλλον της, ή ένας ιδιοκτήτης που προστατεύει τη μεγαλύτερη επένδυσή του, είμαστε εδώ για να προσφέρουμε εξατομικευμένες λύσεις προσαρμοσμένες στις δικές σας μοναδικές ανάγκες. Πιστεύουμε στο χτίσιμο σχέσεων, όχι απλώς στην πώληση συμβολαίων, γιατί όταν πρόκειται για τη διασφάλιση των ονείρων σας, αξίζετε έναν συνεργάτη που σας στηρίζει πραγματικά.",
